...
const DashboardHead = () => {
  ...
  return (
    <div className='flex justify-between md:justify-center items-center p-4 md:p-0 sticky md:relative top-0 bg-softDark md:bg-transparent z-10 md:z-0 shadow-md md:shadow-none'>
